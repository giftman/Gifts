...
%end
%%%%%计算相关性%%%%
sim=(sum(zhongkai3.*zhongkai_source))/(sum(zhongkai3.*zhongkai3));
imwrite(zhongkai3, strcat(int2str(attack_style), '.bmp'))
simsave(attack_style)=sim;
PSNRsave(attack_style)=PSNR;
end
