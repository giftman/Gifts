% BY 通信工程071班  赵楚凡 如何将SK保存了下来……reshape 还有先'倒置再转也行
clear all
clc
...
data='Can you feel my world?if you say no iloveyouC#221';
...
SK=zeros(16*mn,48);
for ii=1:mn
    d=da((ii-1)*64+1:ii*64);%按64位为一份取数据
